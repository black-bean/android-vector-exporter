...
| 扫描列表 | 导出完成 |
|:---:|:---:|
| ![扫描列表](screenshot/screenshot-20260512-195113.png) | ![导出完成](screenshot/screenshot-20260512-195143.png) |

> 左图：图标列表，红色色点表示硬编码色值，❌ 标签表示命名不规范（含 `-` / 空格），不可勾选导出。  
> 右图：导出完成后可逐个复制/下载，或点「⬇️ 下载全部」打包为 zip。
